...
-   Hunter labour market (employment): Latest quarter shows growth in employment in public services and consumer facing sectors, and declines in agriculture, mining, manufacturing, and utilities. 11,500 jobs added in the first six months of 2023.
...
<iframe src="figs/gdp_annual.html" width="800" height="600">
...
<iframe src="figs/gdp_quarter.html" width="800" height="600">
...
<iframe src="figs/NAB_business.html" width="800" height="600">
...
<iframe src="figs/employment_hunter_monthly.html" width="800" height="600">

</iframe>

[Data source: ABS Labour Force, Australia, Detailed. [Data in tabular format available here.](figs/employment_hunter_monthly_tab.html)]{style="font-size: small;"}
...
<iframe src="figs/unemployment_hunter_monthly.html" width="800" height="600">
...
<iframe src="figs/unemployment_hunter_bar12months.html" width="800" height="600">
...
<iframe src="figs/employment_hunter_industry_change.html" width="800" height="600">
...
<iframe src="figs/employment_hunter_industry_change_3month.html" width="800" height="600">
...
<p style="display: flex; justify-content: center;">
    ...
    <button id="button11" style="background-color: #f2f2f2; font-size: 14px; border: 0.5px solid white" onclick="loadPlot1('figs/houseprices_facs.html')">Values</button>
    <button id="button12" style="background-color: #f2f2f2; font-size: 14px; border: 0.5px solid white" onclick="loadPlot1('figs/houseprices_facs_indexed.html')">Indexed</button>
    </p>
</p>
<iframe id="plotFrame1" src="figs/houseprices_facs_indexed.html" width="800" height="600"></iframe>
...
```
[[NSW Govt Rent and Sales Report](https://www.facs.nsw.gov.au/resources/statistics/rent-and-sales/dashboard)]{style="font-size: small;"}
...
<iframe src="figs/house_prices_last_quart_facs.html" width="800" height="600">
...
<button id="button21" style="background-color: #f2f2f2; font-size: 14px; border: 0.5px solid white" onclick="loadPlot2(&#39;figs/rentalprices_nswfacs.html&#39;)">

Values

</button>

<button id="button22" style="background-color: #f2f2f2; font-size: 14px; border: 0.5px solid white" onclick="loadPlot2(&#39;figs/rentalprices_nswfacs_indexed.html&#39;)">
...
<iframe id="plotFrame2" src="figs/rentalprices_nswfacs_indexed.html" width="800" height="600">
...
```
[[NSW Govt Rent and Sales Report](https://www.facs.nsw.gov.au/resources/statistics/rent-and-sales/dashboard). Data indexed to start 2009.]{style="font-size: small;"}
...
<iframe src="figs/rentalprices_last_quart.html" width="800" height="600">
