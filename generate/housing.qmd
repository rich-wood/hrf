...
<iframe src="../Dashboard_Working/html_figs/migration.html" width="850" height="800" style="display: block; margin: 0 auto;">
...
<iframe src="../Dashboard_Working/html_figs/Percentage_Rent.html" width="850" height="800">
...
<iframe src="../Dashboard_Working/html_figs/houseprices_triple_Hunter-Total.html" width="1250" height="950">
...
<p style="display: flex; justify-content: center;">
    ...
    <button id="button11" style="background-color: #f2f2f2; font-size: 14px; border: 0.5px solid white" onclick="loadPlot1('../Dashboard_Working/html_figs/rentalprices_nswfacs.html')">Values</button>
    <button id="button12" style="background-color: #f2f2f2; font-size: 14px; border: 0.5px solid white" onclick="loadPlot1('../Dashboard_Working/html_figs/rentalprices_nswfacs_indexed.html')">Indexed</button>
    </p>
</p>
<iframe id="plotFrame1" src="../Dashboard_Working/html_figs/rentalprices_nswfacs_indexed.html" width="800" height="600"></iframe>
...
<iframe src="../Dashboard_Working/html_figs/sales_rents_ratio.html" width="800" height="580">
...
<iframe src="../Dashboard_Working/html_figs/cpi_housing.html" width="800" height="600">
...
<iframe src="../Dashboard_Working/html_figs/construction_ppi.html" width="800" height="600">
...
This shows the number of building approvals by type since 2016 for the whole of the Hunter. <iframe src=../Dashboard_Working/html_figs/building_type_hunter.html width="800" height="600"></iframe>

The same in a cumulative figure (building approvals by type since 2016 for the whole of the Hunter). Clearly the detached house is the main focus of development in the Hunter <iframe src=../Dashboard_Working/html_figs/building_type_hunter_cumul.html width="800" height="600"></iframe>
...
<!-- Figure -->
<iframe id="plotFrame2" src="../Dashboard_Working/html_figs/BuildApprov_Map_Anim_HousesSA2.html" width="800" height="600"></iframe>
...
<script type="text/javascript">
    ...
    function loadPlot(figureType, isCumulative) {
        ...
        var figureFile = `../Dashboard_Working/html_figs/BuildApprov_Map_Anim_${figureType}`;
...
<iframe src="../Dashboard_Working/html_figs/AllHomelessAusNswHunter.html" width="800" height="600">
...
<iframe id="plotFrame" src="../Dashboard_Working/html_figs/homelessness1.html" width="800" height="600">
...
<script type="text/javascript">
    ...
    function loadFigure(category) {
        ...
        var figureFile = `../Dashboard_Working/html_figs/homelessness${category}.html`;
